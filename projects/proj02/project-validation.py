...
(
    q2_correlations
    .plot(kind='barh', 
          title='Correlations Between Interest Rate and Various Quantitative Features',
...
def loan_purpose_over_time(loans):
    ...
    loan_purpose_yearly = (loan_purpose_yearly.reset_index()
                                              .melt(id_vars='issue_d', var_name='Purpose', value_name='Frequency')
                                              .sort_values(by=['issue_d', 'Frequency'], ascending=False))    
    fig = px.line(loan_purpose_yearly, x='issue_d', y='Frequency', color='Purpose', 
                  color_discrete_sequence=px.colors.qualitative.Dark24, title='Trends in Loan Purposes Over Time')
